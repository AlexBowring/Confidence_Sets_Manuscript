...
for i = 1:nominal_levels_dim(2)
    ...
    for j = 1:sim_results_mat_dim(1)
        for k = 1:sim_results_mat_dim(2)
            ...
            raw_sensitivity_result              = (raw_volume_prct_store'*raw_subset_success)/nRlz;
            ...
            observed_sensitivity_result         = (observed_volume_prct_store'*observed_subset_success)/nRlz;
            nSubj                               = sprintf('nSubj');
            sim_covering_levels_and_subs(1,k,j,i) = temp.(raw_sensitivity_result);
...
filename = fullfile(outdir, '3DSensitivityResults.mat');
