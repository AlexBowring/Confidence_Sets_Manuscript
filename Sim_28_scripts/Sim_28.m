function Sim_28(nSubj,SvNm,nRlz)
...
for t=1:nRlz
    ...
    observed_std  = zeros(prod(dim),1);
      ...
      observed_boundary_std = sqrt(1 + thr^2);
      resid_boundary_values = (1./observed_boundary_std)*resid_boundary_values;
      observed_resid_boundary_values = (1./observed_boundary_std)*observed_resid_boundary_values;
    ...
    lower_contour_raw_80             = observed_cohen_d >= (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_raw_80*tau*observed_cohen_d_std;
    ...
    lower_contour_observed_80             = observed_cohen_d >= (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_observed_80*tau*observed_cohen_d_std;
    ...
    lower_condition_80 = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_raw_80*tau*observed_cohen_d_std;
    upper_condition_80 = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_raw_80*tau*observed_cohen_d_std;
    lower_condition_90 = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_raw_90*tau*observed_cohen_d_std;
    upper_condition_90 = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_raw_90*tau*observed_cohen_d_std;
    lower_condition_95 = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_raw_95*tau*observed_cohen_d_std;
    upper_condition_95 = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_raw_95*tau*observed_cohen_d_std;
    ...
    lower_condition_80_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_observed_80*tau*observed_cohen_d_std;
    upper_condition_80_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_observed_80*tau*observed_cohen_d_std;
    lower_condition_90_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_observed_90*tau*observed_cohen_d_std;
    upper_condition_90_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_observed_90*tau*observed_cohen_d_std;
    lower_condition_95_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr - supGa_observed_95*tau*observed_cohen_d_std;
    upper_condition_95_observed = (1 - (3/(4*nSubj - 5)))^(-1)*thr + supGa_observed_95*tau*observed_cohen_d_std;
